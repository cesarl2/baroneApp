            ...
            <nav class="navbar navbar-default">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll sticky-logo" href="index.html">
                  <span><img class="barone" src="img/Barone.png" alt=""></span>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">Los mejores diseños para cada ocasion</h2>
                </div>
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">No dejes que la moda te domine, tú decides quién eres y qué quieres expresar</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#services">Iniciar Sesion</a>
                  <a class="ready-btn page-scroll" href="#about">Registrarme</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content text-center">
                ...
                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">Trabajando con pasion</h2>
                </div>
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">Para brindarte la mejor experiencia</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                <!-- layer 1 -->
                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">Lo que tengas en mente </h2>
                </div>
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">Nosotros te ayudamos para hacerlo realidad</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              ...
              <p>
                Barone es una empresa que su prioridad es brindarle a sus clientes la mejor calidad de nuestros productos y generar la mejor experiencia con ellos
              </p>
              <ul>
                <li>
                  <i class="fa fa-check"></i> Diseñamos a tu gusto
                </li>
                <li>
                  <i class="fa fa-check"></i> Te accesoramos para que cumplas tus expectativas
                </li>
                <li>
                  <i class="fa fa-check"></i> La responsabilidad es nuestra prioridad
                </li>
                <li>
                  <i class="fa fa-check"></i> Contamos con excelentes instalaciones
                </li>
                <li>
                  <i class="fa fa-check"></i> Hacemos productos de calidad
                </li>
              </ul>
            </div>
          </div>
